...
{
    private static String className = OdaMongoDriver.class.getName();
			...
			throws OdaException
	{
		...
		String className = OdaMongoDriver.class.getName( );
    										...
    										String logPrefix )
    {
             ...
             logDirectory.startsWith( "." ) )
        {
            try
            {
        	    URL url = OdaMongoDriver.getManifest().getDriverLocation();
        	    if( url != null )
        	    {
